      ...
      <div>
              ...
              {items.map(({ title, href, icon, color }) => {
                return (
                  <Link
                    ...
                    scroll={false}
                  >
                    <div className="w-full h-full bg-white rounded-lg p-4 transition-all duration-300 border border-blue-100 hover:shadow-lg hover:border-opacity-100 hover:scale-105 active:border-blue-200">
        ...
        <div>
          <section className="flex flex-col gap-y-24 py-32 bg-[#007cc2] xl:gap-y-40">
            {/*  */}
            <div
              className="flex flex-col gap-y-10 mx-auto max-w-7xl px-8 scroll-my-24 md:px-12 lg:px-16 xl:px-24"
              id="sas-gobierno"
            >
              <div>
                <p

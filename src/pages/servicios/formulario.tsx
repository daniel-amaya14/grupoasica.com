...
import FormServices from '@/components/Forms/FormServicios';
      ...
      <div className="relative max-w-7xl px-4 py-10 mx-auto sm:px-6 lg:px-8 lg:py-14">
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-800 tracking-wide">
              Ayudamos a grandes y pequeñas empresas a alcanzar su máximo
              potencial mediante servicios estratégicos y soluciones
              personalizadas.
            </p>
          ...
          <div className="relative">
            <div className="flex flex-col rounded-xl p-4 bg-white/90 sm:p-6 lg:p-10">

...
import ImgCursos from '@/public/images/management.webp';
      ...
      <div className="relative w-full px-6 py-20 xl:px-16 bg-gray-200">
        ...
        <div>
          ...
          <p className="relative text-white max-w-xl text-justify">
            Aprenderás las mejores prácticas en coaching y técnicas para
            promover hábitos saludables y positivos en la vida de tus clientes.
          </p>
        </div>
      </div>

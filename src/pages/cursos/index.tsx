  ...
  return (
    <section className="">
      ...
      <div className="w-full flex flex-col px-6 pt-12 xl:px-16 lg:flex-row lg:justify-between">
        <div className="relative mb-10  lg:max-w-2xl">
          <h2 className="mb-6 text-2xl font-semibold text-justify sm:text-3xl sm:leading-none">
        ...
        <div className="w-full sm:mx-auto sm:w-3/4 md:bg-white md:shadow md:p-8 md:rounded-lg lg:relative lg:-top-36 lg:w-2/5 lg:left-10">
          <h3 className="mb-4 text-xl font-semibold sm:text-2xl sm:leading-none">
            Solicitar certificaciones y capacitaciones
          </h3>

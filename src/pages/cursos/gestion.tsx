...
import ImgCursos from '@/public/images/wellness.jpg';
      ...
      <div className="relative w-full px-6 py-20 xl:px-16 bg-gray-200">
        ...
        <div>
          ...
          <p className="relative text-white max-w-xl text-justify">
            Fortalece tus habilidades en gestión y liderazgo con nuestro
            diplomado especializado. Desarrolla tu capacidad para liderar
            equipos y alcanzar objetivos organizacionales.
          </p>
        </div>
      </div>

...
export default function Page404() {
  return (
    <div className="w-full flex flex-col lg:flex-row items-center justify-center py-10 sm:py-20 gap-10">
      <div className="w-full lg:w-1/3 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-6 px-4">
      ...
      <div className="w-1/2 lg:h-full flex justify-center">
        <svg
